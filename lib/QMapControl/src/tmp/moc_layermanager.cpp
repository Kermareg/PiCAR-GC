...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_qmapcontrol__LayerManager_t, stringdata) + ofs \
...
QT_MOC_LITERAL(1, 26, 13), // "updateRequest"
QT_MOC_LITERAL(2, 40, 0), // ""
QT_MOC_LITERAL(3, 41, 4), // "rect"
QT_MOC_LITERAL(4, 46, 6), // "resize"
QT_MOC_LITERAL(5, 53, 7) // "newSize"

    },
    "qmapcontrol::LayerManager\0updateRequest\0"
    "\0rect\0resize\0newSize"
};
...
void qmapcontrol::LayerManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->updateRequest((*reinterpret_cast< QRectF(*)>(_a[1]))); break;
...
const QMetaObject qmapcontrol::LayerManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_qmapcontrol__LayerManager.data,
      qt_meta_data_qmapcontrol__LayerManager,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *qmapcontrol::LayerManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_qmapcontrol__LayerManager.stringdata))
