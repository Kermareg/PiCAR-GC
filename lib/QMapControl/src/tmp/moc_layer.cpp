...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_qmapcontrol__Layer_t, stringdata) + ofs \
...
QT_MOC_LITERAL(1, 19, 15), // "geometryClicked"
QT_MOC_LITERAL(2, 35, 0), // ""
QT_MOC_LITERAL(3, 36, 9), // "Geometry*"
QT_MOC_LITERAL(4, 46, 8), // "geometry"
QT_MOC_LITERAL(5, 55, 5), // "point"
QT_MOC_LITERAL(6, 61, 13), // "updateRequest"
QT_MOC_LITERAL(7, 75, 4), // "rect"
QT_MOC_LITERAL(8, 80, 10), // "setVisible"
QT_MOC_LITERAL(9, 91, 7) // "visible"

    },
    "qmapcontrol::Layer\0geometryClicked\0\0"
    "Geometry*\0geometry\0point\0updateRequest\0"
    "rect\0setVisible\0visible"
};
...
void qmapcontrol::Layer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Layer::*_t)(Geometry * , QPoint );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Layer::geometryClicked)) {
                *result = 0;
            }
        }
        {
            typedef void (Layer::*_t)(QRectF );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Layer::updateRequest)) {
                *result = 1;
            }
        }
        {
...
const QMetaObject qmapcontrol::Layer::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_qmapcontrol__Layer.data,
      qt_meta_data_qmapcontrol__Layer,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *qmapcontrol::Layer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_qmapcontrol__Layer.stringdata))
