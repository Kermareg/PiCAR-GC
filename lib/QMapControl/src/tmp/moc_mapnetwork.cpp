...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_qmapcontrol__MapNetwork_t, stringdata) + ofs \
...
QT_MOC_LITERAL(1, 24, 15), // "requestFinished"
QT_MOC_LITERAL(2, 40, 0), // ""
QT_MOC_LITERAL(3, 41, 14), // "QNetworkReply*"
QT_MOC_LITERAL(4, 56, 5) // "reply"

    },
    "qmapcontrol::MapNetwork\0requestFinished\0"
...
void qmapcontrol::MapNetwork::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        MapNetwork *_t = static_cast<MapNetwork *>(_o);
        switch (_id) {
...
const QMetaObject qmapcontrol::MapNetwork::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_qmapcontrol__MapNetwork.data,
      qt_meta_data_qmapcontrol__MapNetwork,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *qmapcontrol::MapNetwork::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_qmapcontrol__MapNetwork.stringdata))
