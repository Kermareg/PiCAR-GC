...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_qmapcontrol__TileMapAdapter_t, stringdata) + ofs \
...
const QMetaObject qmapcontrol::TileMapAdapter::staticMetaObject = {
    { &MapAdapter::staticMetaObject, qt_meta_stringdata_qmapcontrol__TileMapAdapter.data,
      qt_meta_data_qmapcontrol__TileMapAdapter,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *qmapcontrol::TileMapAdapter::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_qmapcontrol__TileMapAdapter.stringdata))
