...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_qmapcontrol__Point_t, stringdata) + ofs \
...
const QMetaObject qmapcontrol::Point::staticMetaObject = {
    { &Geometry::staticMetaObject, qt_meta_stringdata_qmapcontrol__Point.data,
      qt_meta_data_qmapcontrol__Point,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *qmapcontrol::Point::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_qmapcontrol__Point.stringdata))
