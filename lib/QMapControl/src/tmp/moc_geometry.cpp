...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_qmapcontrol__Geometry_t, stringdata) + ofs \
...
void qmapcontrol::Geometry::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Geometry::*_t)(Geometry * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Geometry::updateRequest)) {
                *result = 0;
            }
        }
        {
            typedef void (Geometry::*_t)(QRectF );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Geometry::updateRequest)) {
                *result = 1;
            }
        }
        {
            typedef void (Geometry::*_t)(Geometry * , QPoint );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Geometry::geometryClicked)) {
                *result = 2;
            }
        }
        {
            typedef void (Geometry::*_t)(Geometry * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Geometry::positionChanged)) {
                *result = 3;
            }
        }
    }
...
const QMetaObject qmapcontrol::Geometry::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_qmapcontrol__Geometry.data,
      qt_meta_data_qmapcontrol__Geometry,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *qmapcontrol::Geometry::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_qmapcontrol__Geometry.stringdata))
