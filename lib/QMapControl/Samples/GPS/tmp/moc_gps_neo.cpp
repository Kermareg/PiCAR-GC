...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_GPS_Neo_t, stringdata) + ofs \
...
static const uint qt_meta_data_GPS_Neo[] = {
 ...
 // signals: parameters
    QMetaType::Void, QMetaType::Float, QMetaType::QPointF,    2,    2,
...
void GPS_Neo::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        GPS_Neo *_t = static_cast<GPS_Neo *>(_o);
        switch (_id) {
        case 0: _t->new_position((*reinterpret_cast< float(*)>(_a[1])),(*reinterpret_cast< QPointF(*)>(_a[2]))); break;
        ...
        {
            typedef void (GPS_Neo::*_t)(float , QPointF );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GPS_Neo::new_position)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject GPS_Neo::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_GPS_Neo.data,
      qt_meta_data_GPS_Neo,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *GPS_Neo::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_GPS_Neo.stringdata))
