...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_LinesAndPoints_t, stringdata) + ofs \
...
const QMetaObject LinesAndPoints::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_LinesAndPoints.data,
      qt_meta_data_LinesAndPoints,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *LinesAndPoints::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_LinesAndPoints.stringdata))
        return static_cast<void*>(const_cast< LinesAndPoints*>(this));
