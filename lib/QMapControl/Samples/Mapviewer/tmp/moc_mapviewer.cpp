...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Mapviewer_t, stringdata) + ofs \
...
const QMetaObject Mapviewer::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_Mapviewer.data,
      qt_meta_data_Mapviewer,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Mapviewer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Mapviewer.stringdata))
